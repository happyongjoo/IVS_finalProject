...
# ===========================
# Parking Function (수정됨: picam2, M 인자 추가)
# ===========================
def parking(servo, motor, picam2, M):
    ...
    try:
        while True:
            ...
            angle_deg = fit_lane_angle_deg(roi) 
...
def main():
    ...
    try:
        while True:
            ...
            # [수정됨] 파란색 주차구역 체크 - picam2와 M 전달
            is_parking, _ = IsParkingZone(hsv, servo, motor, picam2, M)
            if is_parking:
                return  # 주차 후 프로그램 종료
